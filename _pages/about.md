...
His research aims to develop **trustworthy**, **efficient**, and **clinically relevant AI systems** that improve medical decision-making and patient care. His current interests include **Large Language Models (LLMs)**, **Clinical Natural Language Processing (Clinical NLP)**, **Medical Image Analysis**, **Computer Vision**, **Vision-Language Models (VLMs)**, **Explainable AI (XAI)**, **Federated Learning**, and **Efficient AI, Model Optimization, or Trustworthy Machine Learning**, with a particular emphasis on translating cutting-edge AI research into practical healthcare solutions.
